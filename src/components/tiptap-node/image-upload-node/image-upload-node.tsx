...
import { X, CloudUpload, FileImage } from "lucide-react";
...
const CloudUploadIcon: React.FC = () => (
  <CloudUpload className="tiptap-image-upload-icon" />
);

const FileIcon: React.FC = () => (
  <FileImage className="tiptap-image-upload-dropzone-rect-primary" />
);

const FileCornerIcon: React.FC = () => (
  <FileImage className="tiptap-image-upload-dropzone-rect-secondary" />
);
